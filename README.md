...
*(Screenshots available in the `screenshots/` folder if added.)*
...
Make sure you have JavaFX SDK installed.

Add the following VM options to run JavaFX:
...
👨‍🏫 Instructor: RRN(Professor Dr. Md Rashedur Rahman)
   ```bash
